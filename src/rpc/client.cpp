...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "swifthints", 0, "command", ParamFormat::STRING },
    { "swifthints", 1, "blockhash", ParamFormat::STRING },
    { "swifthints", 2, "record", ParamFormat::STRING },
    { "swifthints", 3, "swifthints", ParamFormat::STRING },
